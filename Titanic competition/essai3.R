...
source("./data/dataProcessedLinearAge/trainValidationTestSet.R")
...
#====initial cost====
cat("initial cost :",costFunctionReg(initial_theta,X,y,lambda),"\n")
#Pause
...
cat('Cross Validation error: ', costFunctionReg(theta,Xval,yval,0),"\n")
