...
#process sex and embarked variables
...
#dump(c("X","y","Xval","yval","Xtest"),file="./logistic regression/trainValidationTestSet.R")
save(X,y,Xval,yval,Xtest,file="./logistic regression/trainValidationTestSet.rda")