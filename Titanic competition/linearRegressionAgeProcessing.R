...
cost <- result$value
#====Training error====
cat('Train error: ', linearRegCostFunction(theta,X,y,lambda),"\n")
#====Validation error====
cat('Validation error,lambda=0: ', linearRegCostFunction(theta,Xval,yval,lambda),"\n")
...
#===replace missing data by linear regression====
data <- 
